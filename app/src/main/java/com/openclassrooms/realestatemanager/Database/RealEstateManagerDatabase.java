    ...
    private static Callback prepopulateDatabase() {
        return new Callback() {
            ...
            public void onCreate(@NonNull SupportSQLiteDatabase db) {
                ...
                houseOne.put("school", 1);
                houseOne.put("shopping", 1);
                houseOne.put("publicTransport", 1);
                houseOne.put("swimmingPool", 1);
                ...
                houseTwo.put("school", 0);
                houseTwo.put("shopping", 0);
                houseTwo.put("publicTransport", 0);
                houseTwo.put("swimmingPool", 1);
                ...
                houseThree.put("school", 1);
                houseThree.put("shopping", 1);
                houseThree.put("publicTransport", 1);
                houseThree.put("swimmingPool", 0);
